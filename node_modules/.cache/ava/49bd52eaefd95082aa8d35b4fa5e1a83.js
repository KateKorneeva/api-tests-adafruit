...
var _feed = _interopRequireDefault(require("./helpers/schemas/feed.json"));
...
(0, _ava.default)('Create feed works', async t => {
  ...
  (0, _shortcuts.validateBySchema)(t, resp.data, _feed.default);
...
(0, _ava.default)(createFeedMacro, {
  name: null,
  description: null
}, 400);
(0, _ava.default)(createFeedMacro, {
...
(0, _ava.default)('Without name feed is not created', createFeedMacro, {
  description: 'test1'
}, 400);
(0, _ava.default)('Create feed with not unique name fails', async t => {
  const feed = {
    name: 'autotest-feed-not-unique'
  };
  const resp1 = await t.context.api.post('/feeds', feed);
  t.is(resp1.status, 201, (0, _shortcuts.responseErrMessage)(resp1));
  const resp2 = await t.context.api.post('/feeds', feed);
  t.is(resp2.status, 400, (0, _shortcuts.responseErrMessage)(resp2));
});
...
//# sourceMappingURL=/home/kate/moeco/adafruit/node_modules/.cache/ava/49bd52eaefd95082aa8d35b4fa5e1a83.js.map