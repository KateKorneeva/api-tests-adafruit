...
_ava.default.only('Add data to feed works', async t => {
  const feed = {
    name: 'autotest-feed-with-dataff11111112s35',
    description: 'feed with data generated by api afutoftest111111s235'
  };
  ...
  t.is(respData.data.value, data.value);
  t.is(respData.data['feed-key'], feedKey);
...
// });
//# sourceMappingURL=/home/kate/moeco/adafruit/node_modules/.cache/ava/d5e6751e9a6a8b1dbd7291355211aa2a.js.map