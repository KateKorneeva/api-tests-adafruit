...
_ava.default.serial.only('Get all feeds returns empty result without token', async t => {
  (0, _shortcuts.logout)(t.context.api);
  const resp = await t.context.api.get('/feeds');
  t.is(resp.status, 200, (0, _shortcuts.responseErrMessage)(resp));
...
// });
//# sourceMappingURL=/home/kate/moeco/adafruit/node_modules/.cache/ava/6e41b8dfddcec9ffe702933ca3d3e67f.js.map