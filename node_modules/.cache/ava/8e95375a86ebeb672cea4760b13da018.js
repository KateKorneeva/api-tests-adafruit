...
_ava.default.only('Add data to feed works', async t => {
  const feed = {
    name: 'autotest-feed-with-data1111111',
    description: 'feed with data generated by api autotest111111'
  };
  const resp = await t.context.api.post('/feeds', feed);
  t.is(resp.status, 201, (0, _shortcuts.responseErrMessage)(resp));
...
// });
//# sourceMappingURL=/home/kate/moeco/adafruit/node_modules/.cache/ava/8e95375a86ebeb672cea4760b13da018.js.map