...
async function macro(t, feedObject, expected) {
...
macro.title = (providedTitle = '', feedObject, expected) => `Create feed with ${JSON.stringify(feedObject)} returns status ${JSON.stringify(expected, null, 2)}. ${providedTitle}`.trim();

_ava.default.only(macro, {
  name: null,
  description: null
}, 400);
...
//# sourceMappingURL=/home/kate/moeco/adafruit/node_modules/.cache/ava/fb8a1a00cfc48896af7d828d8e767bc0.js.map