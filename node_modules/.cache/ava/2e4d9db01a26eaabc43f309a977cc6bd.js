...
_ava.default.serial('Add data to feed fails without auth token', async t => {
  (0, _shortcuts.logout)(t.context.api);
  const data = {
    value: 42
  };
  const respData = await t.context.api.post(`/feeds/${t.context.feed.key}/data`, data);
  t.is(respData.status, 404, (0, _shortcuts.responseErrMessage)(respData));
});
//# sourceMappingURL=/home/kate/moeco/adafruit/node_modules/.cache/ava/2e4d9db01a26eaabc43f309a977cc6bd.js.map