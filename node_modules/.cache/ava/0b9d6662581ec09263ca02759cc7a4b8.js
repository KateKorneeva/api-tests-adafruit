...
_ava.default.before('Create feed', async t => {
  ...
  await (0, _shortcuts.auth)(t.context.api); // Delete all existing feeds
...
_ava.default.beforeEach('Login', async t => {
  await (0, _shortcuts.auth)(t.context.api);
});
...
_ava.default.only('Create feed fails without token', async t => {
  await (0, _shortcuts.logout)(t.context.api);
  const feed = {
    name: 'autotest-feed',
...
_ava.default.only('Create feed fails with wrong inputs', async t => {
  const feed = {
    name: null,
    description: null
  };
...
(0, _ava.default)('Get all feeds works', async t => {
  ...
  console.log(resp.data); // t.is(resp.data[0].owner.username, 'korneed');
...
// });
//# sourceMappingURL=/home/kate/moeco/adafruit/node_modules/.cache/ava/0b9d6662581ec09263ca02759cc7a4b8.js.map