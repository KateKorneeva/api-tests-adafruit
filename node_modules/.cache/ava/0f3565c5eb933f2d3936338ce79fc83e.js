...
_ava.default.only('Add data to feed works', async t => {
  const feed = {
    name: 'autotest-feed-with-dataf11111112s35',
    description: 'feed with data generated by api autoftest111111s235'
  };
  ...
  t.is(respData.data[0].value, data.value);
  t.is(respData.data[0]['feed-key'], feedKey);
...
// });
//# sourceMappingURL=/home/kate/moeco/adafruit/node_modules/.cache/ava/0f3565c5eb933f2d3936338ce79fc83e.js.map