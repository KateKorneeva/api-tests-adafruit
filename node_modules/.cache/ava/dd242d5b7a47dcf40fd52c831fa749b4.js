...
_ava.default.only('Add data to feed works', async t => {
  const feed = {
    name: 'autotest-feed-with-data1111111235',
    description: 'feed with data generated by api autotest111111235'
  };
  ...
  const dataResp = await t.context.api.post(`/feeds/${feedKey}/data`, data);
...
// });
//# sourceMappingURL=/home/kate/moeco/adafruit/node_modules/.cache/ava/dd242d5b7a47dcf40fd52c831fa749b4.js.map