...
_ava.default.only('Without name feed is not created', createFeedMacro, {
  description: 'test1'
}, 400);

_ava.default.only('Create feed with not unique name fails', async t => {
  const feed = {
  ...
  t.is(resp2.status, 201, (0, _shortcuts.responseErrMessage)(resp2));
});
...
//# sourceMappingURL=/home/kate/moeco/adafruit/node_modules/.cache/ava/b49ca6ab617bd6684ea5395c5c953ec3.js.map