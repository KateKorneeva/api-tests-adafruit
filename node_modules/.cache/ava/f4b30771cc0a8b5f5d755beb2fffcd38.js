...
_ava.default.serial('Get all feeds works without token', async t => {
  (0, _shortcuts.logout)(t.context.api);
...
_ava.default.only('Get feed by id works', async t => {
...
_ava.default.serial.only('Get feed by id fails without token', async t => {
  (0, _shortcuts.logout)(t.context.api);
  const resp = await t.context.api.get(`/feeds/${t.context.feed.key}`);
...
// });
//# sourceMappingURL=/home/kate/moeco/adafruit/node_modules/.cache/ava/f4b30771cc0a8b5f5d755beb2fffcd38.js.map